...
public class BinaryImage extends BlurredImage{
	...
	public BinaryImage(BlurredImage inImage){
		...
		this.blurredImagePixels = inImage.getBlurredImagePixels();
		//for some reason the variable below was being set to the first byte image
		this.binaryImagePixels = new int[this.vertical][this.horizontal];
