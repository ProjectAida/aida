...
public class ConsolidationEngine {
	...
	public int[][] noRecursion(Image img) {
		Morphology morph = new Morphology();
		int[][] noRecursion = ImageToolkit.deepCopy(img.getByteImage());
	...
	public int[][] recursion(Image img) {
		Morphology morph = new Morphology();
		int[][] recursion = ImageToolkit.deepCopy(img.getByteImage());
	...
	public int[][] mixedConsolidation(Image img) {
		Morphology morph = new Morphology();
